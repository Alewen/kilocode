...
if [ -n "$1" ]; then
    ...
    # 所有需要同步的包列表
    PKGS="core kilo-web-ui llm plugin-atomic-chat http-recorder kilo-console kilo-vscode opencode kilo-gateway kilo-telemetry kilo-i18n kilo-ui kilo-indexing kilo-jetbrains ui sdk/js plugin script storybook kilo-docs kilo-vscode/tests upstream"
    for pkg in $PKGS; do
...
# 步骤 3: 编译 VS Code 扩展（不传 --force，复用步骤 2 的 CLI 二进制）
echo "[3/5] 编译扩展代码..."
