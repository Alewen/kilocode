...
if (Test-Path -LiteralPath $extensionBin) {
    Copy-Item -LiteralPath "$Src\$Platform\$Config\bwrap.exe" -Destination (Join-Path $extensionBin "bwrap.exe") -Force
    Copy-Item -LiteralPath "$Src\$Platform\$Config\KiloHook.dll" -Destination (Join-Path $extensionBin "KiloHook.dll") -Force
