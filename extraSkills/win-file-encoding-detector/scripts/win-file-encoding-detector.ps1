...
# 返回值：
#   [string] 可能值：
#     "UTF-32LE-BOM" - UTF-32 小端序带 BOM -- FF FE 00 00
#     "UTF-32BE-BOM" - UTF-32 大端序带 BOM -- 00 00 FE FF
#     "UTF-8-BOM"    - UTF-8    编码带 BOM -- EF BB BF
#     "UTF-16LE-BOM" - UTF-16 小端序带 BOM -- FF FE
#     "UTF-16BE-BOM" - UTF-16 大端序带 BOM -- FE FF
#     "NO_BOM" - 没有检测到 BOM
#     "UNKNOWN" - 检测过程出错
# ================================================
function Detect-BOM
